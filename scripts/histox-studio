...
def main(
    ...
    if stylegan:
        from histox.studio.widgets.stylegan import StyleGANWidget
        widgets += [StyleGANWidget]

    if picam:
        from histox.studio.widgets.picam import PicamWidget
        widgets += [PicamWidget]

    if camera:
        from histox.studio.widgets.cvcam import CameraWidget
        widgets += [CameraWidget]

    if cellpose:
        from histox.studio.widgets.cellseg import CellSegWidget
