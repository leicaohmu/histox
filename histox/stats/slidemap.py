...
from histox.stats import stats_utils
...
if TYPE_CHECKING:
    ...
    from histox.model import DatasetFeatures
...
class SlideMap:
    ...
    provided from :class:`histox.DatasetFeatures`.
    """
    ...
    def from_features(
        ...
        **umap_kwargs: Any
        ...
        Args:
            ftrs (:class:`histox.DatasetFeatures`): DatasetFeatures.
