'''PyTorch backend for the histox.model submodule.'''
...
from histox.model.torch_utils import autocast
from histox.model.base import log_manifest, BaseFeatureExtractor
from histox.util import log, NormFit, ImgBatchSpeedColumn, no_scope
...
class Trainer:
    ...
    are supported by :class:`histox.model.RegressionTrainer` and
    :class:`histox.model.SurvivalTrainer`.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            hp (:class:`histox.ModelParams`): ModelParams object.
    ...
    def predict(
        ...
        Args:
            dataset (:class:`histox.dataset.Dataset`): Dataset containing
    ...
    def evaluate(
        ...
        Args:
            dataset (:class:`histox.dataset.Dataset`): Dataset to evaluate.
            batch_size (int, optional): Evaluation batch size. Defaults to the
                same as training (per self.hp)
    ...
    def train(
        ...
        Args:
            train_dts (:class:`histox.dataset.Dataset`): Training dataset.
            val_dts (:class:`histox.dataset.Dataset`): Validation dataset.
...
class RegressionTrainer(Trainer):
    ...
    """Extends the base :class:`histox.model.Trainer` class to add support
...
class Features(BaseFeatureExtractor):
    ...
    def __init__(
        ...
        *,
        ...
        """Creates an activations interface from a saved histox model which
    ...
    def from_model(
        ...
        *,
        ...
        """Creates an activations interface from a loaded histox model which
        outputs feature activations at the designated layers.
        ...
        Args:
            ...
            mixed_precision (bool, optional): Use mixed precision.
                Defaults to True.
            wsi_normalizer (:class:`histox.norm.StainNormalizer`): Stain
    ...
    def __call__(
        ...
        **kwargs
        ...
        either a batch of images or a :class:`histox.slide.WSI` object.
    ...
    def dump_config(self):
        return {
            'class': 'histox.model.torch.Features',
            'kwargs': {
                'path': self.path,
                'layers': self.layers,
...
class UncertaintyInterface(Features):
    ...
    def dump_config(self):
        return {
            'class': 'histox.model.torch.UncertaintyInterface',
            'kwargs': {
                'path': self.path,
                'layers': self.layers,
                'apply_softmax': self.apply_softmax,
