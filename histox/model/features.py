...
class DatasetFeatures:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        Args:
            ...
            dataset (:class:`histox.Dataset`): Dataset from which to
    ...
    def merge(self, df: "DatasetFeatures") -> None:
        ...
        Args:
            df (histox.DatasetFeatures): TargetDatasetFeatures
                to merge with.
    ...
    def _prepare_generator(self, **kwargs) -> Callable:
        ...
        if self.is_extractor():
            ...
            if self.is_tf():
                ...
                from histox.model.torch import Features as TorchFeatures
