...
def mil_config(model: Union[str, Callable], trainer: str = 'fastai', **kwargs):
    ...
    Args:
        ...
        **kwargs: All additional keyword arguments are passed to
            :class:`histox.mil.TrainerConfig`
...
class TrainerConfig:
    ...
    def __init__(
        ...
        **kwargs
        ...
        be created through :func:`histox.mil.mil_config`, which will create
        ...
        Keyword args:
            ...
            **kwargs: All additional keyword arguments are passed to
                :class:`histox.mil.MILModelConfig`.
    ...
    def train(
        ...
        **kwargs
        ...
        """
        from histox.mil.train import _train_mil, _train_multimodal_mil
    ...
    def eval(
        ...
        **heatmap_kwargs
        ...
        """
        from histox.mil.eval import run_eval
...
class MILModelConfig:
    ...
    def _build_dataloader(
        ...
        *,
        ...
        from histox.mil import data as data_utils
    ...
    def predict(self, model, bags, attention=False, apply_softmax=None, **kwargs):
        ...
        from histox.mil.eval import predict_from_bags, predict_from_multimodal_bags
    ...
    def batched_predict(
        ...
        *,
        ...
        """
        from histox.mil.eval import run_inference
