...
def predict_slide(
    ...
    **kwargs
    ...
    Args:
        ...
        extractor (:class:`histox.mil.BaseFeatureExtractor`, optional):
    ...
    Keyword Args:
        normalizer (:class:`histox.stain.StainNormalizer`, optional):
