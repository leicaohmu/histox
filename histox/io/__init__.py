...
from histox.util.tfrecord2idx import get_tfrecord_by_index, get_tfrecord_length
...
if hx.backend() == 'tensorflow':
    ...
    from histox.io.tensorflow import auto_decode_image as decode_image
    ...
    from histox.tfrecord import TFRecordWriter
    from histox.tfrecord.torch.dataset import TFRecordDataset
