...
from histox.stats import get_centroid_index
...
class Mosaic:
    ...
    def __init__(
        ...
        **grid_kwargs
        ...
        Args:
            images (list(np.ndarray), tuple, :class:`histox.SlideMap`):
        ...
        Keyword args:
            ...
            tile_meta (dict, optional): Tile metadata, used for tile_select.
                ...
                Defaults to None.
            normalizer ((str or :class:`histox.norm.StainNormalizer`), optional):
    ...
    def view(self, slides: List[str] = None) -> None:
        ...
        """
        from histox.studio.widgets import MosaicWidget
