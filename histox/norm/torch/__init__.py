...
from histox.io.torch import cwh_to_whc, whc_to_cwh, is_cwh
from histox.norm import StainNormalizer
from histox.norm.torch import reinhard, macenko, cyclegan
from histox.util import detuple, log, cleanup_progress, _as_list
...
class TorchStainNormalizer(StainNormalizer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        Examples
            Please see :class:`histox.norm.StainNormalizer` for examples.
        """
