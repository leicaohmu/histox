...
def split_patients_preserved_site(
    ...
    import histox.io.preservedsite.crossfolds as cv
...
class Dataset:
    ...
    def balance(
        ...
        *,
        ...
        Returns:
            balanced :class:`histox.Dataset` object.
        """
    ...
    def check_duplicates(
        ...
        Args:
            dataset (`histox.Dataset`, optional): Also check for
    ...
    def clip(
        ...
        Returns:
            clipped :class:`histox.Dataset` object.
    ...
    def extract_cells(
        ...
        **kwargs
        ...
        """
        from histox.cellseg.seg_utils import ApplySegmentation
    ...
    def filter(self, *args: Any, **kwargs: Any) -> "Dataset":
        ...
        Returns:
            :class:`histox.Dataset`: Dataset with filter added.
        """
    ...
    def harmonize_labels(
        ...
        *args: "Dataset",
        ...
        Args:
            *args (:class:`histox.Dataset`): Any number of Datasets.
    ...
    def remove_filter(self, **kwargs: Any) -> "Dataset":
        ...
        Returns:
            :class:`histox.Dataset`: Dataset with filter removed.
    ...
    def split(
        ...
        Returns:
            A tuple containing
                ...
                :class:`histox.Dataset`: Training dataset.

                :class:`histox.Dataset`: Validation dataset.
        """
    ...
    def tensorflow(
        ...
        **kwargs: Any
        ...
        Keyword Args:
            ...
            normalizer (:class:`histox.norm.StainNormalizer`, optional):
            ...
            **decode_kwargs (dict): Keyword arguments to pass to
                :func:`histox.io.tensorflow.decode_image`.

        Returns:
            tf.data.Dataset

        """
        from histox.io.tensorflow import interleave
    ...
    def tfrecord_report(
        ...
        Args:
            ...
            normalizer (`histox.norm.StainNormalizer`, optional):
    ...
    def torch(
        ...
        **kwargs: Any
        ...
        """
        from histox.io.torch import interleave_dataloader
    ...
    def unclip(self) -> "Dataset":
        ...
        Returns:
            :class:`histox.Dataset`: Dataset with clips removed.
