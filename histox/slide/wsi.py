...
class WSI:
    ...
    def align_to(
        ...
        *,
        ...
        Args:
            slide (:class:`histox.WSI`): Slide to align to.
        ...
        Raises:
            TypeError: If ``slide`` is not a :class:`histox.WSI` object.
    ...
    def align_tiles_to(
        ...
        **kwargs
        ...
        Differs from :meth:`histox.WSI.align_to` in that it aligns each
        ...
        Keyword Args:
            ...
            **kwargs: Keyword arguments passed to :meth:`histox.WSI.align_to`.
    ...
    def apply_alignment(self, alignment: Alignment) -> None:
        ...
        Args:
            alignment (histox.slide.Alignment): Alignment object.
    ...
    def apply_qc_mask(
        ...
        *,
        ...
        Args:
            mask (np.ndarray or :class:`histox.slide.QCMask`, optional):
    ...
    def apply_segmentation(
        ...
        Args:
            segmentation (histox.cellseg.Segmentation): Segmentation object
                to apply.
    ...
    def build_generator(
        ...
        *,
        ...
        normalizer: Optional[Union[str, "histox.norm.StainNormalizer"]] = None,
        ...
        def generator():
            ...
            if not from_centroids:
                ...
                from histox.cellseg import seg_utils
    ...
    def get_tile_roi(
        ...
        Returns:
            Tuple[int, ROI]: ROI index (index of WSI.rois) and
                the :class:`histox.slide.ROI` that contains the tile.
        ...
        **kwargs
        ...
        Keyword args:
            ...
            generator_kwargs (dict, optional): Keyword arguments passed to
                the :meth:`histox.WSI.build_generator()`.
    ...
    def view(self):
        ...
        """
        from histox.studio import Studio
