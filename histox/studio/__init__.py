...
class Studio(ImguiWindow):
    ...
    def add_widgets(self, widgets: Widget) -> None:
        ...
        Args:
            widgets (list(:class:`histox.studio.widgets.Widget`)): List of
    ...
    def remove_widget(self, widget: Widget) -> None:
        ...
        Args:
            widget (:class:`histox.studio.widgets.Widget`): Widget to remove.
    ...
    def set_viewer(self, viewer: Any) -> None:
        ...
        Args:
            viewer (:class:`histox.studio.gui.viewer.Viewer`): Viewer to use.
