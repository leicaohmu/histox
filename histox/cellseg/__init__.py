...
from histox.segment.utils import outlines_list
from histox.slide.utils import draw_roi
from histox.util import batch_generator, log
...
class Segmentation:
    ...
    def __init__(
        ...
        *,
        ...
        Keyword args:
            slide (histox.WSI): If provided, ``Segmentation`` can coordinate
    ...
    def load(cls, path) -> "Segmentation":
        ...
        Args:
            path (str): Path to *.zip containing saved Segmentation, as created
                through :meth:`histox.cellseg.Segmentation.save`.
    ...
    def apply_rois(
        ...
        Args:
            ...
            annpolys (list(``shapely.geometry.Polygon``)): List of ROI
                polygons, as available in ``histox.WSI.rois``.
    ...
    def save(
        ...
        A :class:`histox.cellseg.Segmentation` object can be loaded from
        this file with ``.load()``.
...
def segment_slide(
    ...
    *,
    ...
    Args:
        slide (str, :class:`histox.WSI`): Whole-slide image. May be a path
    ...
    Returns:
        :class:`histox.cellseg.Segmentation`
    """
